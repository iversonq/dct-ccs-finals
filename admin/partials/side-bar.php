            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="/admin/dashboard.php" 
                       style="font-weight: <?= ($_SERVER['PHP_SELF'] === '/admin/dashboard.php' ? 'bold' : 'normal'); ?>;">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="/admin/subject/add.php" 
                       style="font-weight: <?= ($_SERVER['PHP_SELF'] === '/admin/subject/add.php' || 
                                                 $_SERVER['PHP_SELF'] === '/admin/subject/edit.php' || 
                                                 $_SERVER['PHP_SELF'] === '/admin/subject/delete.php' ? 'bold' : 'normal'); ?>;">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="/admin/student/register.php" 
                       style="font-weight: <?= (in_array($_SERVER['PHP_SELF'], [
